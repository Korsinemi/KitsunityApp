...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        embed.setTitle(`Categoria Acción <a:NekoDance:834162269075931177>`)
            ...
            <a:arrow_kitsunity:839285735018332201> ${ServerPrefix}hug\r
            <a:arrow_kitsunity:839285735018332201> ${ServerPrefix}pat\r
            <a:arrow_kitsunity:839285735018332201> ${ServerPrefix}kiss\r
            <a:arrow_kitsunity:839285735018332201> ${ServerPrefix}slap\r`,
        ...
        return message.channel.send(embed);
            ...
            embed.setTitle(`Categoria Reacción <a:BlushNeko:834162248549007402>`)
                ...
                `<a:kitsunity_sparkling_star:839520700317302825> **Comandos:**
                <a:arrow_kitsunity:839285735018332201> ${ServerPrefix}baka\r
		...
		`<a:kitsunity_sparkling_star:839520700317302825> **Categorias:**`,
